...
var Converter = exports.Converter = function (image, options) {
    ...
    this.sharp.prototype.sharpCrop = this.sharp.prototype.crop;
    this.sharp.prototype.crop = function(crop_width, crop_height, x, y) {
        // TODO! why is x and y not integers? correct order?
        return this.extract(parseInt(y,10), parseInt(x,10), crop_width, crop_height);
    };
...
Converter.prototype.save = function (output, callback) {
    var dir = path.dirname(output)
      , image = this.sharp(this.image)//this.gm(this.image)
